...
// --- PROTECTED PAGES ---
// These must be declared BEFORE the static file middleware below, otherwise
// express.static would serve the raw files to anyone, logged in or not.
...
// --- Serve Static Files (public assets: home.html, about.html, treatments.html, css/js, etc.) ---
...
// 6. Chat with the Gemini agent (Protected)
app.post('/chat', requireAuth, async (req, res) => {
  const { message, history } = req.body;
  
  // 1. Extract the actual logged-in user's Cognito ID from the auth token
  ...
  try {
    // 2. Pass realUserId as the 3rd argument to override the dummy user!
